...
describe('Bowling', () => {
    describe('Finding Bowling score', () => {
        ...
        it('Should throw error when any of the throws in rolls is not a number', () => {
            expect(() => findScore([3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 'a'])).toThrow(Error);

        });
        it('Should throw error when any of the throws in rolls has a value greater than 10 or less than 0', () => {
            expect(() => findScore([3, 6, 3, 6, 3, 16, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6, 3, 6])).toThrow(Error);
